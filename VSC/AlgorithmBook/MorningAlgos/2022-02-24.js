...
class BinarySearchTree {
    ...
    insert(newVal) {
         ...
         *      If it's null create a new root
         *  iterate until the node reaches a suitable location
        ...
        */
        ...
        while (true) {
            ...
            if(loopCount > 100)
            {
                console.error("This Tree is very deep... please cut it down")
            }
        }
    }
    ...
    sumNodesObj(curr=this.root, obj={sum : 0})
    {
        if (curr === null)
        {
            return obj.sum;
        ...
        obj.sum += curr.data;
        this.sumNodes(curr.left, obj)
        this.sumNodes(curr.right, obj)
        return obj.sum;
        
    }

    sumNodes(curr=this.root, sum = 0)
    {
        if (curr === null)
        {
            return sum;
        ...
        sum += curr.data;
        sum = this.sumNodes(curr.left, sum);
        sum = this.sumNodes(curr.right, sum);
        return sum;
